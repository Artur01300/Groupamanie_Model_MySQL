...
-- -----------------------------------------------------
-- Table `groupomania`.`comment_copy1`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `groupomania`.`comment_copy1` (
  `id_avatar` INT NOT NULL AUTO_INCREMENT,
  `url_avatar` TEXT CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_unicode_ci' NOT NULL,
  `name_avatar` TEXT NOT NULL,
  `users_id_user` INT NOT NULL,
