...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `groupomania`.`v_get_one_comment_from_user` (`id_user` INT, `name` INT, `content` INT, `created_at` INT, `id_comment` INT);
...
SELECT users.id_user, users.name, comment.content, comment.created_at, comment.id_comment
